...
class ExecutorMergeSorterTest {
    ...
    void test_ExecutorMergeSorter_Empty() {
        var data = new LinkedList<>();
        var temp= (LinkedList<Integer>) data.clone();
        Collections.sort(temp);

        new ExecutorMergeSorter<>().sort(data);
    ...
    @Test
    @SuppressWarnings("unchecked")
    void test_ExecutorMergeSorter_Integers() {
        LinkedList<Integer> data = SortUtils.generateRandomNumberList(128);
        var temp= (LinkedList<Integer>) data.clone();
        Collections.sort(temp);

        new ExecutorMergeSorter<Integer>().sort(data);
    ...
    @Test
    @SuppressWarnings("unchecked")
    void test_ExecutorMergeSorter_Strings() {
        ...
        new ExecutorMergeSorter<String>().sort(data);
